...
import lightModeBackground from './assets/lightmodebackground.png'; 
...
const HomePage = () => {
  ...
  const backgroundImage = colorMode === 'light' ? lightModeBackground : darkModeBackground;
  ...
  return (
    <Box width="100%" p={4} bgImage={`url(${backgroundImage})`} bgSize="cover" bgPosition="center" minHeight="100vh">
